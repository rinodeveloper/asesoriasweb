...
export default function Contacto() {
  ...
  return (
    <>
      <SEO
        description={
          "Comienza tu asesoría digital para impulsar tu emprendimiento."
        }
      ...
      <div
        ...
        id="sucessModal"
        aria-labelledby="sucessModalCenterTitle"
        aria-modal="true"
        role="dialog"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header  col-12 text-center">
              <h5
                className="modal-title justify-items-center"
                id="sucessModalCenterTitle"
              >
                <svg
