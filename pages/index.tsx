...
export default function Home() {
  return (
    <>
      <SEO
        description={
          "¿Quieres traer tu emprendimiendo a Internet? ¡Te ayudamos a lograrlo!"
        }
      ...
      <div className={"container d-flex flex-wrap flex-row"}>
        <section
          className={
            "col-12 col-md-7 col-sm-12 d-flex flex-column align-self-center"
          }
        >
          <h1 className={"accent"}>Tu Asesor Digital</h1>
          <h3>Mi objetivo es ayudarte a aprovechar la tecnología.</h3>
          <section>
            <div
              className={
                "col-md-6 col-sm-8 d-flex justify-content-between mt-4"
              }
            >
              <Link
                className={
                  "btn btn-outline-primary btn-lg btn-services col-6 col-sm-8 d-flex justify-content-evenly align-items-center"
                }
                href={"#servicios"}
              >
                Servicios
        ...
        <section
          className={"col-5 d-md-flex align-items-center d-sm-none d-none"}
        >
          <Image
        ...
        <section
          className={
            "d-flex flex-row flex-wrap col-12 justify-content-around mt-5"
          }
          id={"servicios"}
        >
          <div
            className={
              "bg-ligth me-md-2 pt-2 text-center col-md-5 col-12 my-sm-2 my-2 tarjeta"
            }
          >
